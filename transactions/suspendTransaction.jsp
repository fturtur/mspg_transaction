...
<script language="javascript" type="text/javascript">
	...
	function validateValues(){
		...
		if(terminalNumber==""||terminalNumber==null||transactionNumber==""||transactionNumber==null||reason==""||reason==null){
			alert("terminalNumber/transactionNumber/reason is empty");
		}
		else{
			document.getElementById('suspendTransactionPage').action="<%=request.getContextPath()%>/suspendTransactionPage.action";
			document.getElementById('suspendTransactionPage').submit();
		}
...
<body>
	<s:form action="suspendTransactionPage" theme="simple"
		id="suspendTransactionPage">
		<table width="680" height="300" border="0" align="center"
			cellpadding="0" cellspacing="0">
			<tr>
				<td><strong class="style3 style4">TRANSACTION SUSPEND
				</strong></td>
			</tr>
			<tr>
				<td><hr /></td>
		...
		<%-- <table align="center" width="500" height="200px" border="0"
			...
			<tr>
				<td>Reason</td>
				<td><s:select headerKey="-1" headerValue="Select Reason"
						list="{'Erroneous Entry of Amount',
		'Erroneous Process of Payment',
		'Acceptance of Erroneous Check',
		'Failure to Follow Billers Acceptance Policies',
